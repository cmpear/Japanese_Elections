...
## RETRIEVE DATA #############################################################################################
ken.codex<-read.delim("C:/Users/cmp53/OneDrive/Documents/kenCodex.csv",sep=",",stringsAsFactors=FALSE)
jElections<-read.csv("C:/Users/cmp53/OneDrive/Documents/R/jElections4.csv",sep=",",stringsAsFactors=FALSE)
#jElections<-jElections[,c(-6,-8,-9,-11)]
jpr<-read.delim("C:/Users/cmp53/OneDrive/Documents/R/jpr.csv",sep=",",stringsAsFactors=FALSE)[,-1]
...
japgeo<-readOGR(dsn="C:/Users/cmp53/OneDrive/Documents/R/jpmap/jp_grid_ken_pgn.shp",stringsAsFactors = FALSE)
